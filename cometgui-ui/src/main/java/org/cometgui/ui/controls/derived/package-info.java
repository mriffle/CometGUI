...
/**
 * Controls CometGUI reuses from Noble-Lab/CasanovoGUI, kept in one place so that the reuse is
 ...
 *
 * <p>The package holds one class as of phase 02, {@link
 * org.cometgui.ui.controls.derived.ConsolePane}, whose own documentation says what was kept from
 * that upstream file and what was changed. A <em>test</em> of derived code is not itself derived
 * material, so {@code ConsolePaneTest} lives outside this path and carries the ordinary header.
 *
