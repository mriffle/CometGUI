...
package org.cometgui.install.testing;
 ...
 *
 * <p>The same class exists in four other modules' test trees. SpotBugs analyses each module on its
 * own and none of them publishes a test jar, so a shared copy would be a production dependency
 * created to serve tests. It is test scaffolding and belongs nowhere near main sources.
 */
