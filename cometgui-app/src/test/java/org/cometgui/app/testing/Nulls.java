 ...
 *
 * <p>Copied deliberately from {@code org.cometgui.domain.testing.Nulls}, for the same reason {@link
 * FxToolkit} is copied: test classes are not published as an artefact.
 */
